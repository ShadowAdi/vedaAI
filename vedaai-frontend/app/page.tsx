...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-zinc-50 to-zinc-100 dark:from-black dark:to-zinc-900">
      {/* Navigation */}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center space-y-8">
          <h1 className="text-5xl sm:text-6xl font-bold text-black dark:text-white leading-tight">
            AI-Powered <span className="bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Assignment Generator</span>
          </h1>
          ...
          <div className="flex justify-center gap-4 pt-4">
            <Link
              href="/assignments/create"
              className="px-8 py-4 rounded-lg font-semibold bg-linear-to-r from-blue-600 to-blue-700 text-white hover:shadow-lg hover:shadow-blue-500/50 transition-all"
            >
              Start Creating →
            </Link>
            <Link
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-8 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:shadow-lg dark:hover:shadow-lg dark:hover:shadow-blue-500/10 hover:shadow-blue-500/10 transition-all"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="text-center">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-linear-to-br from-blue-600 to-purple-600 flex items-center justify-center text-white text-2xl font-bold">
                  {item.step}
                </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {['Next.js 16', 'React 19', 'TypeScript', 'Tailwind CSS', 'Socket.IO', 'Zustand', 'Zod', 'Axios'].map((tech, idx) => (
            <div
              key={idx}
      ...
      <section className="bg-linear-to-r from-blue-600 to-purple-600 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 text-lg mb-8">Start generating AI-powered assessments today</p>
          <Link
            href="/assignments/create"
            className="inline-block px-8 py-4 rounded-lg font-semibold bg-white text-blue-600 hover:bg-blue-50 transition-colors"
          >
